...
namespace pvsaintpe\search\generators\settings;
...
class Generator extends GeneratorDefault
{
    ...
    public $template = 'platproc';
    public $baseControllerClass = 'pvsaintpe\search\components\Controller';
...
//            [['baseSearchModelClass'], 'validateNewClass'],
    ...
    {
        return 'Settings CRUD Generator (Veselov)';
    }
...
//                        $table
    ...
    public function generateSearchConditions()
    {
        ...
        foreach ($tableSchema->columns as $i => $column) {
            if (in_array($i, $keys)) {
                $hashConditions[] = "\$this->query->a('{$i}') => \$this->{$i},";
            }
        }
     ...
     * @return string
     */
    public function generateSettingsParams()
    {
        /* @var $class ActiveRecord */
        $class = $this->modelClass;
        $params = [];
     ...
     * @return string
     */
    public function generateSettingsIdParams()
    {
        /* @var $class ActiveRecord */
        $class = $this->modelClass;
        $params = [];
