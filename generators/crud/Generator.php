...
namespace pvsaintpe\search\generators\crud;
 ...
 *
 * @author Veselov Pavel (pvsaintpe@mail.ru)
 */
...
//                        $table
    ...
    public function generateColumn($tableSchema, $column, $pull_right = false)
    {
        ...
        if (in_array($attribute, $this->__statusAttributes)) {
            ...
            } elseif ($attribute == 'is_default') {
                return "
            '$attribute' => [
                'class' => 'backend\\components\\grid\\DefaultColumn',
                'permissionPrefix' => \$this->getPermissionPrefix(),
            ],";
            } else {
                return "
